...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="224" packageName="@vendure/core" />
...
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="84" packageName="@vendure/core" since="2.2.0" />
