...
An AuthenticationMethod represents the means by which a [User](/reference/typescript-api/entities/user#user) is authenticated. There are three kinds:
[NativeAuthenticationMethod](/reference/typescript-api/entities/authentication-method#nativeauthenticationmethod), [ExternalAuthenticationMethod](/reference/typescript-api/entities/authentication-method#externalauthenticationmethod) and $`ApiKeyAuthenticationMethod`.
